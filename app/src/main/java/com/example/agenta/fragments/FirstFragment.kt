...
import com.example.agenta.adapters.TareaAdapter
...
class FirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnAgregar?.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_FirstFragment_to_nuevaTareaFragment)
        }
        ...
        findNavController().currentBackStackEntry?.savedStateHandle?.getLiveData<Boolean>("refresh")?.observe(viewLifecycleOwner) { refresh ->
            if (refresh == true) {
                recargarListaSegunFiltro()
            }
        }
    ...
    private fun mostrarProximas() {
        ...
        val tareas = viewModel.listaTareas.value ?: mutableListOf()
